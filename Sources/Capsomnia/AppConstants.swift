...
struct AppStrings {
    ...
    let keepAwakeBatteryLocked: String
    let disableKeepAwakeOnBattery: String
    ...
    static func localized(for language: AppLanguage) -> AppStrings {
        ...
        case .english:
            AppStrings(
                ...
                toggleCapsLock: "Keep awake",
                keepAwakeBatteryLocked: "Keep awake (off on battery)",
                disableKeepAwakeOnBattery: "Turn off keep-awake on battery",
                ...
                keyboardShortcutDesc: "Use a shortcut to turn Capsomnia on or off without opening the menu.",
                ...
                explainerOnTitle: "Keep-awake on",
                explainerOnDesc: "System sleep is disabled — work keeps running, lid open or closed, while power policy allows it.",
                explainerOffTitle: "Keep-awake off",
                explainerOffDesc: "Normal sleep behavior resumes.",
                initialPreferencesHeading: "Initial setup",
                preferencesHeading: "Preferences",
                done: "Done",
                getStarted: "Get started",
                tooltipOn: "Keep-awake is on",
                tooltipOff: "Keep-awake is off",
        ...
        case .korean:
            AppStrings(
                ...
                toggleCapsLock: "잠자기 방지",
                keepAwakeBatteryLocked: "잠자기 방지 (배터리에서 꺼짐)",
                disableKeepAwakeOnBattery: "배터리에서 잠자기 방지 끄기",
                ...
                keyboardShortcutDesc: "메뉴를 열지 않고 단축키로 Capsomnia를 켜거나 끕니다.",
        ...
        case .japanese:
            AppStrings(
                ...
                toggleCapsLock: "スリープを防止",
                keepAwakeBatteryLocked: "スリープを防止（バッテリー時はオフ）",
                disableKeepAwakeOnBattery: "バッテリー時はスリープ防止をオフ",
                ...
                keyboardShortcutDesc: "メニューを開かずにショートカットでCapsomniaをオン／オフできます。",
        ...
        case .simplifiedChinese:
            AppStrings(
                ...
                toggleCapsLock: "保持唤醒",
                keepAwakeBatteryLocked: "保持唤醒（电池供电时已关闭）",
                disableKeepAwakeOnBattery: "电池供电时自动关闭唤醒",
                ...
                keyboardShortcutDesc: "无需打开菜单，即可使用自定义快捷键开启或关闭 Capsomnia。",
                ...
                explainerOnTitle: "保持唤醒已开启",
                explainerOnDesc: "系统睡眠已停用——无论开盖还是合盖，任务都会继续运行。",
                explainerOffTitle: "保持唤醒已关闭",
