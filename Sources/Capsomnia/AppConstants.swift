    ...
    static func localized(for language: AppLanguage) -> AppStrings {
        ...
        case .english:
            AppStrings(
                ...
                hideCapsLockIndicatorDesc: "Hide the Caps Lock indicator shown in text fields. This changes an undocumented system-wide macOS setting and may affect other text-cursor indicators. A restart is required.",
        ...
        case .korean:
            AppStrings(
                ...
                hideCapsLockIndicatorDesc: "텍스트 입력란의 Caps Lock 표시기를 숨깁니다. 문서화되지 않은 macOS 시스템 전체 설정을 변경하므로 다른 텍스트 커서 표시에도 영향을 줄 수 있으며 재시동이 필요합니다.",
        ...
        case .japanese:
            AppStrings(
                ...
                hideCapsLockIndicatorDesc: "テキスト入力欄のCaps Lockインジケータを非表示にします。macOSの非公開なシステム全体設定を変更するため、ほかのテキストカーソル表示にも影響する場合があり、再起動が必要です。",
        ...
        case .simplifiedChinese:
            AppStrings(
                ...
                hideCapsLockIndicatorDesc: "隐藏文本输入框中的 Caps Lock 指示器。此功能会更改未公开的 macOS 系统级设置，可能影响其他文本光标指示器，并且需要重新启动。",
