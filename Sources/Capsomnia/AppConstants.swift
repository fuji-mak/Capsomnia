    ...
    static func localized(for language: AppLanguage) -> AppStrings {
        ...
        case .korean:
            AppStrings(
                ...
                autoOffTimerDesc: "설정한 시간이 지나면 절전 방지를 끄고 Mac을 잠자기 상태로 전환합니다. 꺼두면 Caps Lock을 직접 끌 때까지 유지됩니다.",
                autoOffOff: "끄기",
        ...
        case .japanese:
            AppStrings(
                ...
                autoOffTimerDesc: "設定した時間が経過すると、スリープ抑止を解除してMacをスリープさせます。オフのときは、Caps Lockを自分でオフにするまで維持します。",
                autoOffOff: "オフ",
                autoOffCustom: "カスタム",
        ...
        case .simplifiedChinese:
            AppStrings(
                ...
                autoOffTimerDesc: "设定时间结束后会关闭防睡眠并让 Mac 进入睡眠。关闭定时器时，将保持开启，直到你自行关闭 Caps Lock。",
                autoOffOff: "关闭",
                autoOffCustom: "自定义",
