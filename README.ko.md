...
Capsomnia는 텔레메트리를 수집하거나 계정을 요구하지 않습니다. 네트워크 사용은 GitHub 릴리스 API에 대한 하루 1회의 선택적 업데이트 확인(최신 버전 번호만 가져오며 고급 설정에서 끌 수 있습니다)과, 업데이트를 선택했을 때 GitHub에서 설치 프로그램을 다운로드하는 것이 전부입니다.
