...
- Menu bar “Prevent sleep”: provides the same on/off control when Caps Lock is remapped to Control or another key. A physical Caps Lock transition returns control to the original hardware switch.
