...
final class LocalizationTests: XCTestCase {
    ...
    func testEveryLanguageHasSettingsStrings() {
        for language in AppLanguage.allCases {
            ...
            XCTAssertFalse(strings.advancedSettingsTitle.isEmpty)
            XCTAssertFalse(strings.advancedSettingsSubtitle.isEmpty)
            ...
            XCTAssertFalse(strings.shortcutPreviewNote.isEmpty)
